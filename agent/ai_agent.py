...
model = genai.GenerativeModel(
    ...
    system_instruction=(
        ...
        "(stock, finance, promos, sports, cybertrucks, etc.) also dont include news from 'AD HOC NEWS' source and 'openPR.com'.ALSO IF THE NEWS HAS A MENTION OF A DRUG AND THAT DRUG IS BIOSIMILAR KEEP IT ,ELSE DONT, IF IT DOESNT HAVE MENTION OF DRUG BUT IS RELEVANT TO OTHER FACTORS MENTIONED , STILL KEEP IT. For each valid item, add a 'Tag' "
